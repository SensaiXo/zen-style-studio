...
const Blog = () => {
	return (
		<div className="min-h-screen">
			<Helmet>
				<title>Blog - Zen Style Studio</title>
				<meta name="description" content="Einblicke, Tipps und Neuigkeiten aus der Welt des Webdesigns, SEO und der digitalen Präsenz." />
			</Helmet>
			<Navbar />
